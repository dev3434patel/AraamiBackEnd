    ...
    <div class="wsus__wizard_area">
        <div class="wsus__wizard_body">
            ...
            <div class="wsus__wizard_footer">
                <p class="settings">After successfully update all of above files, go to your admin panel, <span>Settings > Database Update</span> . Update database change to work properly with the update.</span>
                </p>
